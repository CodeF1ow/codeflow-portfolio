import { dataAboutPage } from "@/datos";

const LineaTiempo = () => {
  return (
    <section className="flex flex-col justify-center divide-y divide-slate-200">
      <div className="w-full max-w-3xl mx-auto md:pb-40 md:pt-20">
        <div className="-my-6">
          {dataAboutPage.map((data) => (
            ...
            >
              <header className="mb-1 text-2xl font-bold sm:mb-0">
                {data.title}
              </header>
              <div
